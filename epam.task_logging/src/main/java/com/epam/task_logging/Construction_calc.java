...
public class Construction_calc extends Applet implements ActionListener {
/**
*
*/
private static final Logger LOGGER=LogManager.getLogger(Construction_calc.class);
